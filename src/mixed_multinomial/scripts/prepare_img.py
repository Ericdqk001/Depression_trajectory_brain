...
def preprocess(wave: str = "baseline_year_1_arm_1"):
    ...
    print(
        "Sample size after dropping subcortical all zeros, number =",
    ...
    mri_all_features_cov = mri_all_features_cov[
        mri_all_features_cov.household_income != 999
    ]
    ...
    # %% TODO: This section joins the trajectory data
    ...
    dep_traj["class_label"] = dep_traj["class_label"].replace(class_label_mapping)
    ...
    ### Create a dataframe where the hemisphere data is averaged for each subject
